    ...
    while True:
        ...
        if c != -1:
            ...
            if c == 3:              # ctrl-c key
                ...
                Motor.MotorRun(1, 'forward', 0)
                break
            if c == 122:   # z key (speed down)
                speed = speed - 10
                if speed <= 10:
                   speed = 10
                print("Speed down")
            if c == 120:   # x key (speed up)
                speed = speed + 10
                if speed >= 100:
                   speed = 100
                print("Speed up")
